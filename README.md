...
*Снимок этого дашборда, снятый 23.09.2026 (часы машины, UTC+2) при окне 1600×900 — страница
помещается целиком, без прокрутки; данные внутри снимка подписаны самим дашбордом на 23.09.2026,
17:19. Это **иллюстрация** к числам выше, а не их источник: считать следует по файлам, названным
предыдущим абзацем, а не по картинке. Публикуется именно снимок; сама страница `docs/progress/` в
набор не входит, поэтому двух редакций одного файла не возникает. Строка «Клиентская приёмка
пройдена» на снимке относится к тому паспорту поставки, по которому он снят, и на последующие правки
исходников не переносится.*
...
>
> **23.09.2026:** марка в заголовке ниже приведена к действующему имени проекта (Kompas3D MCP,
> репозиторий `Kompas3D-MCP`); сам текст постановки и её формулировки не правились.
